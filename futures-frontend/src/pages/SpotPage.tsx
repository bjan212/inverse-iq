import SpotWalletAnalyst from "@/components/SpotWalletAnalyst";
      ...
      <header className="border-b border-border bg-background/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-bold font-display tracking-tight">Prompt Builder <span className="text-muted-foreground font-normal">/ Spot</span></h1>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/spot">
              <span className="text-sm font-medium text-foreground transition-colors cursor-pointer">Spot Analyst</span>
            </Link>
            <Link href="/boardroom">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto space-y-8">
          <div className="space-y-2">
            <h1 className="text-4xl font-bold font-display tracking-tight text-foreground">Spot Wallet Analyst.</h1>
            <p className="text-lg text-muted-foreground max-w-2xl">
              Build your "Nest Egg" portfolio with AI-driven strategies based on your risk appetite and goals.
            </p>
          </div>
